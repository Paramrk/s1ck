...
const FlavorSection = () => {
    ...
    return (
        <section ref={flavorRef} className="flavor-section relative overflow-hidden">
            ...
            >
                <button type="button" className="text-sm rounded-4xl bg-charcoal text-cream px-10 md:py-4 py-3 cursor-pointer shadow-md hover:bg-sick-red transition-all tracking-widest uppercase" style={{fontFamily: 'Space Grotesk, sans-serif'}}>
                    SHOP THE COLLECTION
                </button>
            </div>
