...
const MenShopPage = () => {
    ...
    useGSAP(() => {
        ...
        // Overlay lightens as hero scrolls
        gsap.to(".men-hero-overlay", {
            opacity: 0.9,
            ease: "none",
            scrollTrigger: {
                trigger: ".men-hero",
    ...
    return (
        <main ref={pageRef} className="bg-cream min-h-dvh">
            ...
            {/* Hero */}
            <section className="men-hero relative h-[70vh] w-full overflow-hidden">
                <div className="men-hero-img-wrap absolute inset-0">
                    <img
                        ref={heroImgRef}
                        src={menImg}
                ...
                <div className="men-hero-overlay absolute inset-0 bg-gradient-to-t from-cream via-cream/50 to-cream/10 z-10" />
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 md:p-14 z-20">
                    <div className="flex items-center gap-4 mb-5">
                        ...
                        <p
                            className="men-hero-breadcrumb text-charcoal/50 text-[0.6rem] uppercase tracking-[0.3em]"
                        ...
                        >
                            ...
                            <span className="text-charcoal/70">Men</span>
                        </p>
                    </div>
                    <div className="overflow-hidden">
                        <h1
                            className="men-hero-title text-charcoal text-5xl md:text-7xl font-bold uppercase tracking-tight"
                    ...
                    <p
                        className="men-hero-sub text-stone text-xs md:text-sm mt-4 uppercase tracking-[0.2em]"
                        style={{ fontFamily: "Inter, sans-serif", fontWeight: 300 }}
                    >
                        Scents engineered for dominance
                    </p>
                </div>
            </section>
